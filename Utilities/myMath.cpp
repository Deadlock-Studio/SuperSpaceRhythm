...
void Vector3::RotateAxis(float angle, Vector3 & axis)
{
	Vector3 vec3 = Vector3(x, y, z);
	Vector4 vec4 = Vector4(x, y, z, 1);
	Matrix rotateMatrix;
	rotateMatrix.SetRotationAngleAxis(angle, axis.x, axis.y, axis.z);
	vec4 = vec4 * rotateMatrix;
